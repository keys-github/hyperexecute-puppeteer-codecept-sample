# Run Puppeteer CodeceptJS Tests with HyperExecute on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can run Puppeteer CodeceptJS tests using HyperExecute. This sample shows how to configure Puppeteer + CodeceptJS + HyperExecute to run on the TestMu AI cloud.
...
```bash
git clone https://github.com/LambdaTest/hyperexecute-puppeteer-codecept-sample && cd hyperexecute-puppeteer-codecept-sample
npm install
```
